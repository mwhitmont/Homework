...
app.config['OAUTH_CREDENTIALS'] = {
    ...
    'github': {
    #    'id': 'f6d7238d2fa0cdbd5dc6',
    #    'secret': '65fba4a0c4a28a79fd519e11895cd14f37b92dca'
...
def testcommand():
    ...
    cmd = 'cd '+mypath + current_user.nickname + ' ; cp ../../' + commandtestfile +' . ; cp ../../' + trainingfile + ' . ; python ' + commandtestfile + ' ; mv ' + commandbase + ' ' + commandbase + '_old'
